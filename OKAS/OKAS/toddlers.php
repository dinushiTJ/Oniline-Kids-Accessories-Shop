		...
		<div class="navbar-container">
			<b>
				<ul class="navbar">
					...
					<li><a>✦</a></li>
					<li><a class="current"  href ="toddlers.php">TODDLER</a></li>
					<li><a>✦</a></li>
			...
			<div class="product-grid product-grid--flexbox">
				<div class="product-grid__wrapper">
					...
					<div class="product-grid__product-wrapper">
						<div class="product-grid__product">
							<div class="product-grid__img-wrapper">			
								<img src="images/shoek1.jpeg" alt="Img" class="product-grid__img" />
							</div>
							<span class="product-grid__title">Kids Leather boy Shoes</span>
							<span class="product-grid__price">Rs.1260.00</span>
					...
					<div class="product-grid__product-wrapper">
						<div class="product-grid__product">
							<div class="product-grid__img-wrapper">			
								<img src="images/shoek2.jpg" alt="Img" class="product-grid__img" />
							</div>
							<span class="product-grid__title">Pink Leather Shoes</span>
							<span class="product-grid__price">Rs.2370.00</span>
							<div class="product-grid__extend-wrapper">
								<div class="product-grid__extend">
					...
					<div class="product-grid__product-wrapper">
						<div class="product-grid__product">
							<div class="product-grid__img-wrapper">			
								<img src="images/shoek3.jpg" alt="Img" class="product-grid__img" />
							</div>
							<span class="product-grid__title">Snickers</span>
							<span class="product-grid__price">Rs.1860.00</span>
							<div class="product-grid__extend-wrapper">
								<div class="product-grid__extend">
					...
					<div class="product-grid__product-wrapper">
						<div class="product-grid__product">
							<div class="product-grid__img-wrapper">			
								<img src="images/bg1.jpg" alt="Img" class="product-grid__img" />
							</div>
							<span class="product-grid__title">pink/red party dress</span>
							<span class="product-grid__price">Rs.1350.00</span>
							<div class="product-grid__extend-wrapper">
								<div class="product-grid__extend">
					...
					<div class="product-grid__product-wrapper">
						<div class="product-grid__product">
							<div class="product-grid__img-wrapper">			
								<img src="images/hg1.jpg" alt="Img" class="product-grid__img" />
							</div>
							<span class="product-grid__title">boo-kit</span>
							<span class="product-grid__price">Rs.1300.00</span>
							<div class="product-grid__extend-wrapper">
								<div class="product-grid__extend">
									<p class="product-grid__description">Greay blue quality leather shoes for babies</p>
									<span class="product-grid__btn product-grid__add-to-cart"><i class="fa fa-cart-arrow-down"></i> Add to cart</span>				
					...
					<div class="product-grid__product-wrapper">
						<div class="product-grid__product">
							<div class="product-grid__img-wrapper">			
								<img src="images/hg2.jpeg" alt="Img" class="product-grid__img" />
							</div>
							<span class="product-grid__title">boo-kit</span>
							<span class="product-grid__price">Rs.1300.00</span>
							<div class="product-grid__extend-wrapper">
					...
					<div class="product-grid__product-wrapper">
						<div class="product-grid__product">
							<div class="product-grid__img-wrapper">			
								<img src="images/ggd.jpeg" alt="Img" class="product-grid__img" />
							</div>
							<span class="product-grid__title">Party or Casual dress</span>
					...
					<div class="product-grid__product-wrapper">
						<div class="product-grid__product">
							<div class="product-grid__img-wrapper">			
								<img src="images/bg2.jpg" alt="Img" class="product-grid__img" />
							</div>
							<span class="product-grid__title">Summer denim lace dress</span>
							<span class="product-grid__price">Rs.1500.00</span>
							<div class="product-grid__extend-wrapper">
								<div class="product-grid__extend">
					...
					<div class="product-grid__product-wrapper">
						<div class="product-grid__product">
							<div class="product-grid__img-wrapper">			
								<img src="images/bg3.jpeg" alt="Img" class="product-grid__img" />
							</div>
